...
PLANTS = (
    ...
    Plant("mismatch", _replace("courthouse/MEASURED.tsv", "plugin-count\t4\t", "plugin-count\t5\t"),
    ...
    Plant("duplicate-key", _append("courthouse/MEASURED.tsv", "plugin-count\t4\t-\tprobe\tduplicate\n"),
    ...
    Plant("foreign-evidence", _replace("courthouse/MEASURED.tsv", "python3 -c 'import json; print(len(",
                                    "python3 ../ward/probe.py # 'import json; print(len("),
    ...
    Plant("ledger-unverified",
          _replace("courthouse/MEASURED.tsv", "plugin-count\t4\t", "plugin-count\t5\t"),
